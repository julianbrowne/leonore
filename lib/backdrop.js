...
define(['util', 'view/svg'], function(util, SVGView) { 
	...
	function Backdrop(view, parent) { 
		...
		if(this.div.className.split(' ').indexOf('view') === -1)
			this.div.className += ' view';
	...
	Backdrop.prototype.empty = function() { 
	...
	Backdrop.prototype.inspect = function() { 
		var str = "";
